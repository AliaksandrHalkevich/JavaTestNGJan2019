...
public class Day2 {
    ...
    @BeforeSuite
    public void setup() {
        System.setProperty("webdriver.gecko.driver", "/Users/Sasha/IdeaProjects/JavaTestNGJan2019/src/test/resources/drivers/geckodriver");
    ...
    private void submitSearch() {
        WebElement inputTextField = driver.findElement(By.cssSelector("#tsf > div:nth-child(2) > div > div.RNNXgb > div > div.a4bIc > input"));
